...
<body class="bg-light">
  <form action="<?php echo base_url(). 'Profiles/save_change_pass' ;?>" method="post" accept-charset="utf-8">
    <input type="hidden" name="UserID" value="<?php echo $this->session->userdata('UserID') ;?>">
    <br>
    <label>Password</label>
    <input class="btn" type="Password" name="Password" value="<?php echo $this->session->userdata('Password') ;?>">
    <br><br>
    <input class="btn btn-warning" type="submit" id="submit" value="Save Password">
