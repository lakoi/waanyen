      ...
      <tbody>
        ...
        {?>
          <tr>
            ...
            <td><img src='<?php echo base_url(). 'img/'.$r->centre_pto ;?>' alt="<?php echo $r->centre_title ;?>" title="" width="90" height="120"/></td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="text-center">
            ...
            <img name="centre_pto" id="centre_pto" src alt="" width="270" height="360"/>
            <!-- </div> -->
